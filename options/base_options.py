...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--useSize', type=int, default=400, help='scale images to this size')
        ...
        parser.add_argument('--input', type=str, default='tdisp', help='chooses input images for AA-UNet')
        parser.add_argument('--dataset', type=str, default='pothole', help='chooses which dataset to load.')
        parser.add_argument('--model', type=str, default='aartfnet', help='chooses which model to use.')
