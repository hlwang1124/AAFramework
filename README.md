...
## Introduction
This is the official pytorch implementation of [**We Learn Better Road Pothole Detection: from Attention Aggregation to Adversarial Domain Adaptation**](https://github.com/hlwang1124/AAFramework/blob/master/eccvw20_pothole.pdf), accepted by [ECCV Workshops 2020](https://iplab.dmi.unict.it/acvr2020/) for publication. This is our [project page](https://sites.google.com/view/pothole-600).
